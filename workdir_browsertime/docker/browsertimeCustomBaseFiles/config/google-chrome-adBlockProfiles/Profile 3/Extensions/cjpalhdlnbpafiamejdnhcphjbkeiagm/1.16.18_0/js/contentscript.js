...
if (typeof vAPI === 'object' && vAPI.supportsUserStylesheets) {
    ...
    vAPI.DOMFilterer.prototype = {
        ...
        hideNode: function (node) {
            if (this.excludedNodeSet.has(node)) {
                return;
            }
            if (this.hideNodeAttr === undefined) {
                return;
            }
        ...
        getFilteredElementCount: function () {
            ...
            if (Array.isArray(details.declarative) === false) {
                return 0;
            }
...
if (typeof vAPI === 'object' && vAPI.userStylesheet === undefined) {
    ...
    vAPI.userStylesheet = {
        ...
        add: function (cssText) {
            if (cssText === '' || this.css.has(cssText)) {
                return;
            }
            if (this.style === null) {
                this.inject();
    ...
    vAPI.DOMFilterer.prototype = {
        ...
        hideNodeObserverHandler: function (mutations) {
            if (vAPI.userStylesheet.disabled) {
                return;
            }
        ...
        hideNode: function (node) {
            ...
            if (this.hiddenNodeset.has(node)) {
                return;
            }
            node.hidden = true;
            this.hiddenNodeset.add(node);
            if (this.hideNodeExpando === undefined) {
                this.hideNodeInit();
            }
            node.setAttribute(this.hideNodeAttr, '');
        ...
        unhideNode: function (node) {
            if (this.hiddenNodeset.has(node) === false) {
                return;
            }
            node.hidden = false;
            node.removeAttribute(this.hideNodeAttr);
...
// https://github.com/gorhill/uBlock/issues/2147
    ...
    vAPI.domWatcher = (function () {
        ...
        var startMutationObserver = function () {
            if (domLayoutObserver !== undefined || !domIsReady) {
                return;
            }
    ...
    vAPI.domSurveyor = (function () {
        ...
        var start = function (details) {
            if (vAPI.domWatcher instanceof Object === false) {
                return;
            }
