...
//   It's an uncommon case, so it's best to unescape only when needed.
    ...
    FilterContainer.prototype.compileGenericUnhideSelector = function (parsed,
                                                                       writer) {
    ...
    FilterContainer.prototype.compileSpecificSelector = function (hostname,
                                                                  parsed,
                                                                  writer) {
    ...
    FilterContainer.prototype.removeFromSelectorCache = function (targetHostname,
                                                                  type) {
    ...
    FilterContainer.prototype.retrieveFromSelectorCache = function (hostname,
                                                                    type,
                                                                    out) {
        let entry = this.selectorCache.get(hostname);
        if (entry !== undefined) {
    ...
    FilterContainer.prototype.retrieveSpecificSelectors = function (request,
                                                                    options) {
